...
describe('Node 클래스 테스트', () => {
  ...
  it('노드 찾기', () => {
    ...
    expect(nodeA.find('2')).toBe(nodeB.find('2'));
    expect(nodeB.find('2')).toBe(nodeC.find('2'));
    expect(nodeC.find('2')).toBe(nodeB);
  });
  ...
  it('오른쪽 방향으로 노드 찾기', () => {
    ...
    expect(nodeA.findRight('3')).toBe(nodeB.findRight('3'));
    expect(nodeB.findRight('3')).toBe(nodeC.findRight('3'));
    expect(nodeB.findRight('1')).toBe(undefined);
  });
  ...
  it('왼쪽 방향으로 노드 찾기', () => {
    ...
    expect(nodeA.findLeft('1')).toBe(nodeB.findLeft('1'));
    expect(nodeB.findLeft('1')).toBe(nodeC.findLeft('1'));
    expect(nodeB.findLeft('3')).toBe(undefined);
  });
